...
创建 webpack 环境，并支持 react 环境的打包工作 (jsx)，babel-loader
...
```js
// @babel/preset-react 支持 jsx 语法的插件
...
```js
// 核心功能 react-refresh，但想在webpack中使用需要 @pmmmwh/react-refresh-webpack-plugin
...
// babel.config.js
module.exports = {
  // presets: ['@babel/preset-env', '@babel/preset-react'], // 下面的写法，方便加参数（扩展）
  presets: [["@babel/preset-env"], ["@babel/preset-react"]],
